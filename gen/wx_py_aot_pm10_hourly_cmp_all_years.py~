...
class MyNavigationToolbar(NavigationToolbar2WxAgg):
	...
	self.aot_pm = []
        ...
        self.aot_pm = self.tot_array_data3
	...
	ax.text(ax.x,30,("pente = %f" % pente))
        ...
        ax.set_title("PM10 (horaire) fonction de l' AOT1020*100 (v15,2006,2007,2009,2010,2012, apres selection)" ,fontsize=8)
	print "pente=%f" % pente
...
class CanvasFrame(wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(self,None,-1,
                         'wx_py_aot_pm10_cmp_all_years.py',size=(550,350))
