...
#datayear = ['Mai','Juin','Juillet','Aout','Septembre','Octobre','Novembre','Décembre'] 
...
class MyNavigationToolbar(NavigationToolbar2WxAgg):
	...
	ax.text(ax.x,60,("sept. a dec. %d"% self.nyear))
	ax.text(ax.x,50,("nombre de points = %d" % size(vg0n_2[:,self.nday])))


	#ax.grid(b='true', which='major',color='black',linestyle='-',linewidth=0.5)
	#print vg0n_2[:,self.nday]
	#print [x for x in vg0n_2[:,self.nday]]
	...
	ax.set_xticklabels(xticklabels,rotation=90, size='xx-small')
...
class CanvasFrame(wx.Frame):
    ...
    def InitConfig(self):
        """On regarde les paramètres initiaux (fichier params.ini)"""
	...
	self.pm10 = self.aot1020
        ...
        self.vg0 = vg0 = mlab.load("aot_2006_sep_dec.txt",comments="#", delimiter=",")
        self.vg0_2 = vg0_2 = mlab.load("pm_2006_sep_dec.txt",comments="#", delimiter=",")
