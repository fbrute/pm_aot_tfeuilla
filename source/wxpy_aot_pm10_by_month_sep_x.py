...
class MyNavigationToolbar(NavigationToolbar2WxAgg):
	...
	self.datamois = [5,6,7,8,9,10,11,12] 
	...
	#print self.nmois
        ...
        ax.set_title('AOT*100 (vert) et PM10 (bleu) mois de %s' % (self.get_mois_en_clair(self.nmois)),fontsize=16)
...
class CanvasFrame(wx.Frame):
    ...
    def PrepData(self):
        ...
        dirtoconv = os.path.join("C:\\", "pctas_data", "aot_join_pm10_selection_dates",'datav2','no_selection')
        os.chdir(dirtoconv)
	...
	self.pm10 = self.aot1020
        ...
        self.vg0 = vg0 = mlab.load("aot_daily_average_2010.txt",comments="#", delimiter=",")
        self.vg0_2 = vg0_2 = mlab.load("pm_daily_average_2010.txt",comments="#", delimiter=",")
